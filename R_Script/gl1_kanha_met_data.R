...
# -----------------------------
roi_shp_path  <- "D:\\NASA_Power_Kanha_Metdata_2020_2021\\ROI\\Grassland_1\\kanha_grass_1.shp"
ndvi_csv_path <- "D:\\NASA_Power_Kanha_Metdata_2020_2021\\Data_Table\\data_ndvi\\gl1_kanha_table_5day_interpolated_SG.csv"
...
output_csv <- file.path(output_folder,
                        "gl1_kanha_ndvi_meteorology.csv")
