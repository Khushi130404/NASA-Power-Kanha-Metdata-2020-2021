...
# 2. Paths (EDIT HERE)
# -----------------------------
input_csv <- "D:/NASA_Power_Kanha_Metdata_2020_2021/Data_Table/data_meteorology/gl1_kanha_ndvi_meteorology.csv"
plot_dir  <- "D:/NASA_Power_Kanha_Metdata_2020_2021/Plots/gl1_kanha_plots"
...
for (met in met_cols) {
  ...
  out_file <- file.path(
    plot_dir,
    paste0("gl1_kanha_NDVI_vs_", met, ".png")
  )
