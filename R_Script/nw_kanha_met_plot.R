...
# 2. Paths (EDIT HERE)
# -----------------------------
input_csv <- "D:/NASA_Power_Kanha_Metdata_2020_2021/Data_Table/data_meteorology/nw_kanha_ndvi_meteorology.csv"
plot_dir  <- "D:/NASA_Power_Kanha_Metdata_2020_2021/Plots/nw_kanha_plots"
